...
use App\Models\Role;
//use Redis;
class BankRoleController extends Controller
{
    public $roleRepo;
    ...
    public function index() {
        ...
        return view('bank/role/roleListing', compact('roles'));
    }
    ...
    public function create() {
        ...
        return view('bank/role/manageRole', compact('navigations', 'permissions', 'role'));
    }
