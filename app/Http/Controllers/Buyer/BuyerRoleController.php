   ...
   //      echo 'test';
     //    Redis::set('name', 'Taylor');
       //echo  Redis::get('name');
        ...
        return view('buyer/role/roleListing', compact('roles'));
    }
    ...
    public function create() {
        ...
        return view('buyer/role/manageRole', compact('navigations', 'permissions', 'role'));
    }
