...
$(function () {
	...
	data = [
		{ label: "৳ 3,500,000,000<br> Paid", data: Math.floor (Math.random() * 100 + 390) },			
...
$(function () {
	...
	data = [
		...
		{ label: "<b>0</b> Pending Approval", data: Math.floor (Math.random() * 100 + 530) }, 
    ...
    shadowSize: 0,
		colors: [$yellow, $yellow, $green, $red, $teal, $green],
	};
