...
@section('sidebar')
	<ul>
		<li><a href="" class="heading">PERMISSION LIST</a></li>
	</ul>
	<div class="pull-right" style="margin: 0 20px 0 0;">
		<a href="{{route('admin.permission.sync')}}"><button type="submit" class="btn btn-info">Sync Permissions</button></a>
	</div>
@stop
@section('content')
                    ...
                    <table class="table table-responsive table-striped table-bordered table-hover no-margin">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="hidden-xs">
                              <a href="{{route('admin.permission.edit',[$permissions->uuid])}}" class="btn btn-warning btn-xs"><i class="fa fa-edit" title="Edit"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
