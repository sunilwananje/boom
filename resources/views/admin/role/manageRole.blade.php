                      ...
                      <div class="form-group">
                        <label for="rptPwd" class="col-sm-2 control-label">Manage Access Rights</label>
                          ...
                          <div class="panel panel-default">
                              <div class="panel-heading">Admin Permissions
                               <label for="adminCheckAll" class="pull-right"><input type="checkbox" id="adminCheckAll" value="1"> Check All</label>
                              </div>
                              <div class="panel-body">
                              @foreach($permissions as $perm)
                                @if(strpos($perm->name, "admin.") !== false)
                                <div class="col-sm-3 col-xs-3 col-md-3">
                                    <label for="perm{{ $perm->id }}" class=""><input type="checkbox" class="admin-per" {{ in_array($perm->id, array_flatten($role->perms()->get(['id'])->toArray())) ? 'checked' : ''  }}  value="{{ $perm->id }}" id="perm{{ $perm->id }}" name="chk[]"> {{ $perm->display_name }}</label>
                                </div>
                                @endif
                              @endforeach
                              </div>
                            ...
                            <div class="panel panel-default">
                              ...
                              <div class="panel-body">
                              @foreach($permissions as $perm)
                              @if(strpos($perm->name, "bank.") !== false)
                              <div class="col-sm-3 col-xs-3 col-md-3">
                            ...
                            <div class="panel panel-default">
                              ...
                              <div class="panel-body">
                              @foreach($permissions as $perm)
                              @if(strpos($perm->name, "buyer.") !== false)
                              <div class="col-sm-3 col-xs-3 col-md-3">
