...
@section('sidebar')
	<ul>
		<li><a href="" class="heading">ROLE LIST</a></li>
	</ul>
	<div class="pull-right" style="margin: 0 20px 0 0;">
		<a href="{{route('bank.role.add')}}"><button type="submit" class="btn btn-primary btn-sm">Create New Role</button></a>
	</div>
@stop
@section('content')
                    ...
                    <table class="table table-responsive table-striped table-bordered table-hover no-margin">
                      ...
                      <tbody>
                        ...
                        <tr>                          
                          ...
                          <td>
                            <a href="/bank/role/edit/{{$role->uuid}}" class="btn btn-warning btn-xs"><i class="fa fa-edit" title="Edit"></i></a>
                            <!-- @if($role->status === "1")
                              <a href="#" class="btn btn-warning"><i class="fa fa-thumbs-down" title="Make Inactive"></i></a>
                            @else
                              <a href="#" class="btn btn-success"><i class="fa fa-thumbs-up" title="Make active"></i></a>
                            @endif -->
                          </td>
                        </tr>
                        @endforeach
