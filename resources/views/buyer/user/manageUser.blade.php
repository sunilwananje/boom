...
@section('sidebar')
  <ul>
    <li><a href="" class="heading"> CREATE USER ACCOUNT </a></li>
  </ul>
@stop
@section('content')
            <!-- Row Start -->
              ...
              <div class="col-lg-12 col-md-12">
                <div class="widget">
                  ...
                  <div class="widget-body">
                    <form id="buyerUserForm" class="form-horizontal no-margin" onsubmit="return false" autocomplete="off">
                    {!! csrf_field() !!}
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          ...
                          <a class="btn btn-info" href="{{route('buyer.user.view')}}">View All</a>
                        </div>
                      </div>
                      <div class="loader">
                         <center>
