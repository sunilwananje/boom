	  ...
	  <a href="/seller/dashboard" class="logo">
        ...
        <ul id="mini-nav" class="clearfix">
          ...
          <li class="list-box user-profile">
            ...
            <ul class="dropdown-menu server-activity">
              <li>
                <p><i class="fa fa-pencil text-info"></i> Edit Profile</p>
              </li>
              <li>
                <a href="/bank/user/resetPassword" style="color:#333; padding: 0px " ><p><i class="fa fa-lock text-info" ></i> Change Password</p></a>
              </li>
              <!-- <li>
