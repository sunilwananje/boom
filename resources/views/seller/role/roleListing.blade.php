...
@section('sidebar')
	<ul>
		<li><a href="" class="heading"> SELLER ROLES <i class="fa fa-info-circle" title="Create user role(s) with associated rights."></i></a></li>
	</ul>
	<div class="pull-right" style="margin: 0 20px 0 0;">
		<a href="{{route('seller.role.add')}}"><button type="submit" class="btn btn-primary btn-sm">Create New Role</button></a>
	</div>
@stop
@section('content')
                    ...
                    <table class="table table-responsive table-striped table-bordered table-hover no-margin">
                      ...
                      <tbody>
                        ...
                        <tr>                          
                          ...
                          <td class="hidden-xs">
                            <a href="{{route('seller.role.edit',[$role->uuid])}}" id="{{$role->uuid}}" class="btn btn-warning btn-xs"><i class="fa fa-edit" title="Edit"></i></a>
                            @if($role->status === "1")
