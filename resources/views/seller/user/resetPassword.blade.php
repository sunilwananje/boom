@extends('supplier.layouts.default')
@section('content')
            <!-- Row Start -->
                  ...
                  <div class="widget-body">
                    ...
                    {!! csrf_field() !!}
                      <div class="form-group">
                        <label for="password" class="col-sm-2 control-label">Password<i class="fa fa-asterisk req_asterisk"></i></label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label for="confirmPassword" class="col-sm-2 control-label">Confirm Password<i class="fa fa-asterisk req_asterisk"></i></label>
                        <div class="col-sm-6">
